...
public class TempHist {
	...
	/**
	 * Instance method that checks returns the most recent temperature sample in the
	 * array as long as the array is not empty
	 * <pre> Usage: <b>tempHist.getLatest().getTempF(), <b>tempHist.getLatest().getTempC(),
